				...
				<div class="container">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<?php $ambil = $koneksi->query("SELECT * FROM t_produk_all WHERE id_produk='$id_produk'");
							...
							?>
								<tr>
									...
									<td>
										<a href="hapuskeranjang?id=<?php echo $id_produk ?>" class="btn btn-danger btn xs">Hapus</a>
									</td>
								</tr>
							<?php $nomor++; ?>
							<?php endforeach ?>
					...
					<a href="home1" class="btn btn-default">Lanjutkan Belanja</a>
					<a href="masuk" class="btn btn-primary">Checkout</a>
			</div>
		</section>