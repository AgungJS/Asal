...
<form action="pencarian" method="get" class="navbar-form">
         <ul class="nav navbar-nav search-nav">
          <li>
           <div class="search">
            <span class="fa fa-search icon-search" style="font-size:23px;"></span>
            <div class="form-group form-animate-text">
              <input type="text" class="form-text" name="keyword" required>
              <span class="bar"></span>
    ...
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-6 col-sm-12">
          <h3 class="animated fadeInLeft">Selamat Belanja</h3>
  ...
  <div class="col-md-12 padding-0">
    <div class="panel box-v2">
      <div class="panel-heading padding-0">
        <img src="asset/img/hujan.gif" class="box-v2-cover img-responsive"/>
        <div class="box-v2-detail">
          <img src="asset/img/js.png" class="img-responsive"/>
          <h4>TIGREAL MOTOR</h4>
        </div>
      </div>
      <div class="panel-body">
        <div class="col-md-12 padding-0 text-center">
          <div class="col-md-6 col-sm-4 col-xs-6 padding-0">
            <h3>C.P</h3>
            <p>0818-0921-9729</p>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 padding-0">
            <h3>E-mail</h3>
            <p>JShope@email.com</p>
          </div>
        </div>
      </div>
    </div>
